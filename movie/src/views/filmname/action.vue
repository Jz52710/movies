                        ...
                        <el-row :span="24">
                            ...
                            <el-col :span="18" style="padding: 5px;margin: 35px 0">
                                <el-row :span="24" style="margin-bottom: 6px">
                                    <el-col :span="14" class="name-box">这个杀手不太冷</el-col>
                                ...
                                <el-row :span="24" style="margin-bottom: 6px">
                                    <el-col class="dyy-box">
                                        ...
                                        <span class="dyname-box">吕克·贝松</span>
                                    </el-col>
                                </el-row>
                                <el-row :span="24" style="margin-bottom: 6px">
                                    <el-col class="dyy-box">
                                        <span class="dy-box">类型：</span>
                                        <span class="dyname-box">剧情 / 动作 / 犯罪</span>
                                    </el-col>
                                </el-row>
                                <el-row :span="24" style="margin-bottom: 6px">
                                    <el-col class="dyy-box">
                                        <span class="dy-box">主演：</span>
                                        <span class="dyname-box">让·雷诺 / 娜塔莉·波特曼 / 加里·奥德曼 / 丹尼·爱罗 / 彼得·阿佩尔 / ...</span>
                                    </el-col>
                                </el-row>
                            </el-col>
                        </el-row>
...
<script>
    ...
    export default {
        ...
        data(){
            return {
                src:'http://dianying.fm/media/poster/129/1295644.jpg',
                url:'http://movie.douban.com/subject/1295644/',
                value:9.4,
            }
        },
        methods: {
