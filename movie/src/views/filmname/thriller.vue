                        ...
                        <el-row :span="24">
                            ...
                            <el-col :span="18" style="padding: 5px;margin: 24px 0">
                                <el-row :span="24" style="margin-bottom: 6px">
                                    <el-col :span="14" class="name-box">消失的爱人</el-col>
                                ...
                                <el-row :span="24" style="margin-bottom: 6px">
                                    <el-col class="dyy-box">
                                        ...
                                        <span class="dyname-box">大卫·芬奇</span>
                                    </el-col>
                                </el-row>
                                <el-row :span="24" style="margin-bottom: 6px">
                                    <el-col class="dyy-box">
                                ...
                                <el-row :span="24" style="margin-bottom: 6px">
                                    <el-col class="dyy-box">
                                        ...
                                        <span class="dyname-box">本·阿弗莱克 / 裴淳华 / 尼尔·帕特里克·...</span>
                                    </el-col>
                                </el-row>
                            </el-col>
                        </el-row>
...
<script>
    ...
    export default {
        ...
        data(){
            return {
                src:'http://dianying.fm/media/poster/213/21318488.jpg',
                url:'http://movie.douban.com/subject/21318488/',
                value:8.7
            }
        },
        methods: {
