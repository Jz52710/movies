                            ...
                            <el-col :span="18" style="padding: 5px;margin: 35px 0">
                                ...
                                <el-row :span="24" style="margin-bottom: 6px">
                                    <el-col class="dyy-box">
                                        ...
                                        <span class="dyname-box">克里斯托弗·诺兰格</span>
                                    </el-col>
                                </el-row>
                                <el-row :span="24" style="margin-bottom: 6px">
                                    <el-col class="dyy-box">
                                        <span class="dy-box">类型：</span>
                                        <span class="dyname-box">剧情 / 科幻 / 悬疑</span>
                                    </el-col>
                                </el-row>
                                <el-row :span="24" style="margin-bottom: 6px">
                                    <el-col class="dyy-box">
                                        <span class="dy-box">主演：</span>
                                        <span class="dyname-box">马修·麦康纳 / 安妮·海瑟薇 / 杰西卡·查...</span>
                                    </el-col>
                                </el-row>
                            </el-col>
                        </el-row>
...
<script>
    ...
    export default {
        ...
        data(){
            return {
                src:'http://dianying.fm/media/poster/188/1889243.jpg',
                url:'http://movie.douban.com/subject/1889243/',
                value:9.1,
            }
        },
        methods: {
