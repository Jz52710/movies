                        ...
                        <el-row :span="24">
                            ...
                            <el-col :span="18" style="padding: 5px;margin: 35px 0">
                                <el-row :span="24" style="margin-bottom: 6px">
                                    <el-col :span="14" class="name-box">调音师</el-col>
                                    <el-col :span="8" class="year-box">2010</el-col>
                                </el-row>
                                <el-row :span="24" style="margin-bottom: 6px">
                                    <el-col class="db-box">
                                        <el-rate
                                ...
                                <el-row :span="24" style="margin-bottom: 6px">
                                    <el-col class="dyy-box">
                                        ...
                                        <span class="dyname-box">Olivier Treiner</span>
                                    </el-col>
                                </el-row>
                                <el-row :span="24" style="margin-bottom: 6px">
                                    <el-col class="dyy-box">
                                        <span class="dy-box">类型：</span>
                                        <span class="dyname-box">剧情 / 悬疑 / 惊悚</span>
                                    </el-col>
                                </el-row>
                                <el-row :span="24" style="margin-bottom: 6px">
                                    <el-col class="dyy-box">
                                        <span class="dy-box">主演：</span>
                                        <span class="dyname-box">格雷戈瓦·勒普兰斯-林盖 / Danièle Lebrun...</span>
                                    </el-col>
                                </el-row>
                            </el-col>
                        </el-row>
...
<script>
    ...
    export default {
        ...
        data(){
            return {
                src:'http://dianying.fm/media/poster/684/6846495.jpg',
                url:'http://movie.douban.com/subject/6846495/',
                value:9.2,
            }
        },
        methods: {
